...
class ConfirmMoney extends StatefulWidget {
  const ConfirmMoney({Key? key}) : super(key: key);

  @override
  State<ConfirmMoney> createState() => _ConfirmMoneyState();
}

class _ConfirmMoneyState extends State<ConfirmMoney> {
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text('Confirm your MPIN',style: GoogleFonts.viga(fontWeight: FontWeight.bold,fontSize: 16),),
            ),
            Container(
